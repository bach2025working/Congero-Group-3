        ...
        pin_errbuf_t            *ebufp)
{
        ...
        *r_flistpp = NULL;
        ...
        /*
         *  Params:
         *    field: name of the field to be retrieved
         *    var: variable to hold the return value (NULL if missing)
         *    label: label of the field to add to error message
         *  This macro takes the above params and check their existence, if not, it will set missing_fields to 1
         *  and append the label to the error message
         */
        ...
        /*
         * Checking the existence of all required fields
         */
        ...
        /*
         * If there is a missing field, we return error code 1 with a list of missing fields
        ...
        PIN_ERR_CLEAR_ERR(ebufp); // clear error buffer before proceeding
        ...
        *r_flistpp = PIN_FLIST_CREATE(ebufp);
        ...
        if (PIN_ERR_IS_ERR(ebufp)) {
                PIN_ERR_LOG_MSG(PIN_ERR_LEVEL_ERROR,
                                "ERROR AFTER CALLING PCM COMMIT CUS");
                PIN_ERR_LOG_EBUF(PIN_ERR_LEVEL_ERROR,
                                "fm_nai_commit_customer PCM_OP error", ebufp);
                ...
                PIN_FLIST_FLD_SET(*r_flistpp, PIN_FLD_ERROR_CODE,
                                  (void *)"0", ebufp);
                PIN_FLIST_FLD_SET(*r_flistpp, PIN_FLD_ERROR_DESCR,
                                  (void *)"Customer committed successfully", ebufp);
        
                poid_t *cust_poid =
                        PIN_FLIST_FLD_GET(pcm_return_flist,
                                          PIN_FLD_POID, 0, ebufp);
        
                if (cust_poid != NULL) {
                        PIN_FLIST_FLD_SET(*r_flistpp, PIN_FLD_POID,
                                          (void *)cust_poid, ebufp);
                } else {
                        PIN_ERR_LOG_MSG(PIN_ERR_LEVEL_WARNING,
                                        "No POID returned from PCM_OP_CUST_COMMIT_CUSTOMER");
                }
        }
